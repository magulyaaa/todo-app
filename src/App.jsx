...
function App() {
  ...
  const [todos, setTodos] = useState([]) // alapértelemezet belső állapot egy üres tömb, ha bekerül egy todo, akkor a tömb növekedik, ha törlünk egy todo-t, akkor pedig csökken
